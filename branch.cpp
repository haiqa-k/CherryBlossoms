...
#include <GL/glut.h>        // Open Graphics Library Utilities header
...
void branch::drawSelf()
{
    ...
    glColor3f(0.404, 0.267, 0.11); // you can change tree color here <-----
...
void display() 
{
    ...
    glPushMatrix();  
        ...
        glColor3f(0, 1, 0); // Color can be changed from here
        glBegin(GL_QUADS);
        glTexCoord2f(1, 1);
        glVertex3f(-10, -10, 0);
        glTexCoord2f(0, 1);
...
int main(int argc, char **argv) 
{
    ...
    win.width = 640*2;
    win.height = 480*2;
    win.title = "Drawing Cherry Blossom Tree";
